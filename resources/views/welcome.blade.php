                    ...
                    <div class="row">
                        <div class="col-lg-6 offset-lg-6">
                            <div class="hi-text">
                                ...
                                <h1>Be <strong>strong</strong> and train hard</h1>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="cs-item">
                        ...
                        <p>Membantu anda untuk mengatur pola makan sehat dengan makanan tinggi nutrisi yang dapat membesarkan otot. </p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="cs-item">
                        ...
                        <p>Program ini dapat melibatkan berbagai jenis latihan, penggunaan alat olahraga, serta mungkin memasukkan aspek-aspek seperti nutrisi dan pemulihan dalam upaya mencapai hasil yang optimal.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="cs-item">
                        ...
                        <p>Bertujuan untuk mencapai hasil kebugaran yang spesifik, seperti mengatasi kelemahan atau tujuan pribadi.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="ts-item set-bg" data-setbg="style/img/team/profile.png">
                            <div class="ts_text">
                                ...
                                <span>Gym Trainer</span>
                                <h5><a href="about.html">view</a></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
